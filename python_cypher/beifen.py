...
# from python_cypher.AES.AES import AES
# aes=AES()
...
def encrypt():
    try:
        ...
        if algorithm == 'AES':
            ...
            result = DES.des_encrypt(data, key)
        elif algorithm == 'RSA':
            result = RSA.rsa_encrypt(data, key)
        elif algorithm == 'PlayFair':
            result = pfa.encrypt(data, key)
        elif algorithm == '单表代替':
            result = db.encrypt(data, key)
        elif algorithm == '放射密码':
            result = fs.encrypt(data,key)
        else :
